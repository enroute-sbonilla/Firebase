...
Feature: The user should be able to check the browser health in a period of 2 months
     ...
     Scenario: The user is going to check the firebase for November - December
        Given A client is in Firebase sign in page
        When I log in with account
        And I navigate to "jwplayer" page 
        And I select a date filter from 11/1/2018 to 12/31/2018
     ...
     Scenario: The user is going to check the firebase for middle October - middle December
        Given A client is in Firebase sign in page
        When I log in with account
        And I navigate to "jwplayer" page 
