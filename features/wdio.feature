@manual
Feature: The user should be able to the WDIO graphs using different date filters

    Scenario: Visualize the WDIO graph with a filter for a range of a month
    ...
    Scenario: Visualize the WDIO graph with a filter for a range of three months
        Given A client is in Firebase sign in page
        When I log in with account
        And I navigate to "jwplayer" page 
    ...
    Scenario: Visualize the WDIO graph with a filter for a range of 15 days
        Given A client is in Firebase sign in page
        When I log in with account
        And I navigate to "jwplayer" page 
    ...
    Scenario: Visualize the WDIO graph with a filter for a range of 7 days
        Given A client is in Firebase sign in page
        When I log in with account
        And I navigate to "jwplayer" page 
